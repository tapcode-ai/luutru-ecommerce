          ...
          <div className="hidden md:flex flex-1 max-w-2xl mx-4" ref={searchRef}>
            <div className="relative w-full">
              <Input
                ...
                className="w-full h-11 pl-5 pr-12 rounded-2xl bg-secondary border-border focus:border-red-500 text-sm"
              />
              <button className="absolute right-1.5 top-1/2 -translate-y-1/2 w-9 h-9 rounded-xl bg-gradient-to-r from-red-600 to-red-700 flex items-center justify-center hover:from-red-700 hover:to-red-800 transition-all duration-200">
            ...
            >
              <div className="relative">
                <Input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full h-11 pl-5 pr-12 rounded-2xl bg-secondary border-border"
                  autoFocus
                />
                <button className="absolute right-1.5 top-1/2 -translate-y-1/2 w-9 h-9 rounded-xl bg-gradient-to-r from-red-600 to-red-700 flex items-center justify-center">
                  <Search className="w-4 h-4 text-white" />
                </button>
              </div>
            </motion.div>
